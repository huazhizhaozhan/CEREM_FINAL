...
def get_span(start_ids, end_ids, with_prob=False):
    ...
    #     print('after start_ids', start_ids)
    #     print('after end_ids', end_ids)
...
class SpanEvaluator(object):
    ...
    def accumulate(self):
        ...
        """
        # print("判断正确的span, 预测的span， 真实的span个数", self.num_correct_spans, self.num_infer_spans, self.num_label_spans)
